...
public class CloudinaryService(IConfiguration configuration) : ICloudinaryService
{
    ...
    {
        var defaultPath = configuration["CloudinarySettings:DefaultAvatarPath"] ?? "avatarForDefault.png";
    ...
    {
        var baseUrl = configuration["CloudinarySettings:BaseUrl"] ?? "https://res.cloudinary.com/dmpzttrwn/image/upload/v1773381597/";
        var folder = configuration["CloudinarySettings:Folder"] ?? "gastreat_gt/profyles";
        var defaultPath = configuration["CloudinarySettings:DefaultPath"] ?? "avatarForDefault.png";
