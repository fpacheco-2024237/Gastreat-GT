...
export default function OrderDetailScreen() {
  ...
  // Intenta reconstruir el pedido si la lista no lo trajo en params.
  useEffect(() => {
    if (!data && id) {
  ...
  const handleAction = async (action, statusPayload) => {
    try {
      // Cliente cancela; admin avanza el estado de la comanda.
  ...
  return (
    // Detalle y acciones separadas por rol para mantener la pantalla legible.
